  ...
  const handleProfileImageUpload = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
        if (!file.type.startsWith('image/')) {
            alert('Faqat rasm (image) yuklashingiz mumkin!');
            return;
        }
    ...
    if (file && user) {
        ...
        reader.onloadend = () => {
            const newHighlight: WeeklyHighlight = {
                ...
                curatorId: user.id, // Uploaded by current user
                seasonId: selectedSeason, // Use selected season
                weekNumber: selectedWeek,
  ...
  return (
    <section id="dashboard" className="py-10 md:py-20 bg-[#0a0a0c] min-h-screen">
      <div className="max-w-[1800px] mx-auto px-4 lg:px-10">
        ...
        {/* Navigation Tabs */}
        <div className="flex justify-start md:justify-center mb-10 md:mb-16 overflow-x-auto no-scrollbar pb-4 -mx-4 px-4 md:mx-0 md:px-0">
          <div className="inline-flex p-1.5 bg-white/5 rounded-[2.5rem] border border-white/5 backdrop-blur-2xl shadow-2xl shrink-0">
            {/* SWAPPED: Notifications is now first */}
            <button 
              onClick={() => setActiveTab('notifications')}
              className={`flex items-center space-x-3 px-6 md:px-8 py-3 md:py-4 rounded-3xl text-[10px] font-black transition-all relative ${
                activeTab === 'notifications' ? 'bg-purple-600 text-white shadow-2xl' : 'text-slate-500 hover:text-white'
              }`}
            >
            ...
            <button 
              ...
              className={`flex items-center space-x-3 px-6 md:px-8 py-3 md:py-4 rounded-3xl text-[10px] font-black transition-all ${
                activeTab === 'panel' ? 'bg-indigo-600 text-white shadow-2xl' : 'text-slate-500 hover:text-white'
              }`}
            >
            ...
            <button 
              ...
              className={`flex items-center space-x-3 px-6 md:px-8 py-3 md:py-4 rounded-3xl text-[10px] font-black transition-all ${
                activeTab === 'profile' ? 'bg-indigo-600 text-white shadow-2xl' : 'text-slate-500 hover:text-white'
              }`}
            >
        ...
        {activeTab === 'profile' && (
          <div className="max-w-5xl mx-auto space-y-12 animate-in fade-in duration-500">
            {isEditingProfile ? (
              ...
              <div className="glass rounded-3xl md:rounded-[48px] border border-white/5 p-6 md:p-14 relative overflow-hidden bg-[#0a0a0c] shadow-2xl">
                <div className="flex flex-col lg:flex-row gap-8 md:gap-10 items-start">
                   ...
                   <div className="flex-1 space-y-6 w-full">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                         ...
                         <div className="space-y-2">
                            ...
                            <input 
                               type="text" 
                               className="w-full bg-[#121214] border border-white/5 rounded-2xl py-4 px-6 text-white focus:border-indigo-500 transition-all outline-none"
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                         ...
                         <div className="space-y-2">
                            <label className="text-[10px] font-black uppercase text-indigo-400 tracking-widest ml-1">PAROL (YANGILASH)</label>
                            <div className="relative">
                               <input 
                                  type={showPassword ? "text" : "password"} 
                                  className="w-full bg-[#121214] border border-white/5 rounded-2xl py-4 px-6 pr-14 text-white focus:border-indigo-500 transition-all outline-none"
                   ...
                   <div className="flex flex-row lg:flex-col gap-3 shrink-0 w-full lg:w-auto">
                      <button onClick={handleSaveProfile} className="flex-1 lg:flex-none bg-[#00c288] hover:bg-[#00a876] text-white px-8 py-4 rounded-2xl font-black text-xs uppercase tracking-widest flex items-center justify-center gap-3 transition-all shadow-lg shadow-[#00c288]/10">
                         <Save className="w-4 h-4" /> SAQLASH
                      </button>
                      <button onClick={() => setIsEditingProfile(false)} className="flex-1 lg:flex-none bg-[#1a1a1f] hover:bg-[#25252b] text-slate-400 hover:text-white px-8 py-4 rounded-2xl font-black text-xs uppercase tracking-widest transition-all flex items-center justify-center">
                         BEKOR
                      </button>
                   </div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                   <div className="space-y-10">
                       <div className="space-y-4">
                          <label className="text-[10px] font-black uppercase text-slate-500 tracking-widest ml-1 flex items-center gap-2">
                             <Info className="w-3 h-3" /> TARJIMAI HOL (TAHRIR)
                          </label>
                          <textarea 
                       ...
                       <div className="space-y-4">
                          <label className="text-[10px] font-black uppercase text-slate-500 tracking-widest ml-1 flex items-center gap-2">
                             <Quote className="w-3 h-3" /> MOTIVATSION SO'Z
                          </label>
                          <input 
                             type="text" 
                   ...
                   <div className="space-y-10">
                      <div className="space-y-4">
                         <label className="text-[10px] font-black uppercase text-slate-500 tracking-widest ml-1 flex items-center gap-2">
                            <Briefcase className="w-3 h-3" /> SOHANGIZ
                         </label>
                         <input 
                            type="text" 
                            className="w-full bg-[#121214] border border-white/5 rounded-2xl py-6 px-6 text-white focus:border-indigo-500 transition-all outline-none"
                      ...
                      <div className="space-y-4">
                         <label className="text-[10px] font-black uppercase text-slate-500 tracking-widest ml-1 flex items-center gap-2">
                            <Zap className="w-3 h-3" /> KO'NIKMALAR
                         </label>
                         <textarea 
              ...
              <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
                ...
                <div className="lg:col-span-2 h-fit bg-[#0f0f12] rounded-3xl border border-white/5 p-6 md:p-8 flex flex-col items-center text-center relative overflow-hidden group shadow-2xl">
                   ...
                   <h2 className="text-3xl font-black text-white tracking-tight mb-2 relative z-10">{user?.name}</h2>
                   <p className="text-indigo-500 font-bold text-xs uppercase tracking-[0.2em] mb-6 relative z-10">{user?.field || 'Soha kiritilmagan'}</p>
                ...
                <div className="lg:col-span-3 space-y-6 flex flex-col h-full">
                   <div className="bg-[#0f0f12] rounded-3xl border border-white/5 p-6 md:p-10 flex-1 shadow-2xl">
                      ...
                      <div className="mb-10">
                        ...
                        <p className="text-lg text-slate-300 leading-relaxed font-light whitespace-pre-wrap">{user?.longBio || "Ma'lumot kiritilmagan."}</p>
                      </div>
                      ...
                      <div className="bg-[#151518] rounded-2xl p-6 border border-white/5 border-l-4 border-l-indigo-500 relative overflow-hidden shadow-lg">
                         ...
                         <p className="text-slate-400 italic leading-relaxed relative z-10 whitespace-pre-wrap">
                   ...
                   <div className="bg-[#0f0f12] p-12 rounded-3xl border border-white/5 flex items-center justify-center relative overflow-hidden min-h-[240px] shadow-2xl">
                      ...
                      <p className="text-3xl md:text-4xl font-black text-white italic text-center leading-tight relative z-10 max-w-2xl">
            ...
            {user?.role === 'curator' && (
               <div className="glass rounded-3xl md:rounded-[48px] border border-white/5 p-6 md:p-14 shadow-2xl">
                  <div className="flex items-center justify-between mb-12">
                     ...
                     {user.isApproved && (
                       <button onClick={() => setIsAssigningStudent(true)} className="px-6 py-4 bg-indigo-600 text-white rounded-2xl font-black text-[10px] uppercase flex items-center gap-2 shadow-lg hover:scale-105 active:scale-95 transition-all">
                     ...
                     {uniqueStudents.length > 0 ? uniqueStudents.map(s => (
                       <div key={s.id} className="p-6 md:p-8 bg-white/5 border border-white/5 rounded-2xl flex items-center justify-between group hover:border-indigo-500/30 transition-all shadow-lg">
                          <div className="flex items-center gap-6">
                             {s.avatar ? (
                               <img src={s.avatar} alt={s.name} className="w-12 h-12 rounded-2xl object-cover border border-white/5 shadow-sm" />
                             ) : (
                               <div className="w-12 h-12 rounded-2xl bg-[#1a1a1f] border border-white/5 flex items-center justify-center transition-all">
                          ...
                          <button 
                            ...
                            className="p-4 text-slate-700 hover:text-red-500 transition-all"
                          >
        ...
        {activeTab === 'panel' && (
          <div className="animate-in fade-in duration-500 space-y-16">
             ...
             {user?.role === 'curator' && !user.isApproved ? (
                <div className="py-32 flex flex-col items-center justify-center text-center space-y-8 glass rounded-[4rem] border-dashed border border-indigo-500/20 shadow-2xl">
               ...
               <>
                 <div className="flex flex-col xl:flex-row xl:items-end justify-between gap-10">
                    <div>
                       <h2 className="text-indigo-500 font-black tracking-[0.3em] uppercase text-[10px] mb-4 flex items-center gap-2"><Layout className="w-4 h-4" /> Boshqaruv Markazi</h2>
                       <div className="flex flex-col sm:flex-row items-center gap-8">
                          <h1 className="text-6xl md:text-8xl font-black text-white tracking-tighter">Hafta #0{selectedWeek}</h1>
                       </div>
                    </div>
                 </div>
                        ...
                        curatorsWithProgress.length > 0 ? curatorsWithProgress.map(({ curator, progress }, index) => (
                            <div key={curator?.id || `unknown-${index}`} className="space-y-6">
                                ...
                                >
                                    <div className="flex items-center gap-6">
                                        {curator?.avatar ? (
                                            <img src={curator.avatar} alt={curator.name} className="w-14 h-14 rounded-2xl object-cover shadow-xl border border-white/5" />
                                        ) : (
                                ...
                                <table className="w-full text-left border-collapse table-auto">
                                    ...
                                    <tbody className="divide-y divide-white/5">
                                        {filteredProgress.length > 0 ? filteredProgress.map((item) => {
                                            ...
                                            <tr><td colSpan={6} className="py-24 text-center text-slate-700 font-black uppercase tracking-widest text-xs">Hozircha ma'mulot kiritilmagan</td></tr>
                                        )}
                                    </tbody>
                                </table>
                            </div>
                 ...
                 <div className="pt-12 md:pt-16 border-t border-white/5 relative">
                    ...
                    <div className="space-y-8 md:space-y-12">
                        ...
                        <div className="min-h-[300px] glass rounded-[3rem] border border-white/5 p-4 md:p-8 bg-[#0a0a0c]/40 relative overflow-hidden shadow-2xl">
                             {/* Content Grid */}
                            {filteredHighlights.length > 0 ? (
                                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-6">
                                    {filteredHighlights.map((highlight) => (
                                        <div 
                                          key={highlight.id} 
                                          className="group relative aspect-[4/5] rounded-[2rem] overflow-hidden border border-white/5 bg-[#121214] cursor-pointer transition-all duration-500 hover:border-purple-500/50 hover:shadow-[0_0_30px_rgba(168,85,247,0.15)] hover:-translate-y-2 shadow-xl" 
                                        ...
                                        >
                                            ...
                                            <div className="absolute top-4 right-4 z-20 opacity-0 group-hover:opacity-100 transition-all duration-300 translate-y-2 group-hover:translate-y-0">
                                               <div className="w-10 h-10 bg-white/10 backdrop-blur-md rounded-full flex items-center justify-center border border-white/5 text-white">
              ...
              <div className="space-y-6">
                 {filteredNotifications.length > 0 ? filteredNotifications.map((notif) => (
                    <div 
                       ...
                       className={`relative p-6 md:p-8 rounded-[2.5rem] border transition-all cursor-pointer group ${
                          notif.isRead 
                       ...
                       <div className="flex items-start gap-6">
                          ...
                          <div className="flex-1">
                             ...
                             <div className="mt-4 flex items-center gap-2">
                                ...
                                <span className="text-[9px] font-black text-indigo-400 uppercase tracking-widest">{notif.sender}</span>
                             </div>
                          </div>
                       </div>
                    </div>
           ...
           <div className="fixed inset-0 z-[300] bg-black/90 backdrop-blur-3xl overflow-y-auto py-10 px-4 md:px-10 animate-in fade-in zoom-in duration-500">
              <div className="flex min-h-full items-center justify-center">
                 <div className="glass w-full max-w-5xl border border-white/5 rounded-[3rem] md:rounded-[4.5rem] relative shadow-[0_0_100px_rgba(79,70,229,0.15)] overflow-hidden">
                    <button onClick={() => setSelectedUserForView(null)} className="absolute top-4 right-4 md:top-8 md:right-8 p-3.5 bg-white/5 text-slate-400 hover:text-white hover:bg-red-500/20 rounded-full transition-all border border-white/5 z-30 group">
                    ...
                    <div className="p-6 md:p-16">
                       <div className="flex flex-col lg:flex-row items-center gap-8 md:gap-12 mb-10 md:mb-16 border-b border-white/5 pb-10 md:pb-16">
                          <div className="relative group shrink-0">
                             <div className="w-44 h-44 md:w-56 md:h-56 rounded-[3.5rem] md:rounded-[4.5rem] bg-[#121214] border-4 border-white/5 overflow-hidden flex items-center justify-center text-indigo-400 text-7xl font-black shadow-2xl relative z-10 transition-transform group-hover:scale-[1.02] duration-500">
                          ...
                          <div className="text-center lg:text-left flex-1 space-y-6">
                             <div className="space-y-2">
                                ...
                                <h2 className="text-5xl md:text-7xl font-black text-white tracking-tighter leading-none">{selectedUserForView.name}</h2>
                                <p className="text-2xl md:text-3xl font-bold text-slate-500 tracking-tight">@{selectedUserForView.username}</p>
                             </div>
                          </div>
                       </div>
                       ...
                       <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                          <div className="lg:col-span-2 space-y-8">
                             <div className="space-y-4">
                                ...
                                <div className="relative p-6 md:p-10 bg-[#121214]/50 border border-white/5 rounded-[2.5rem]">
                                   <p className="text-xl md:text-2xl text-slate-300 leading-relaxed font-medium italic relative z-10">"{selectedUserForView.longBio || 'Ma\'lumot kiritilmagan.'}"</p>
                                </div>
                             </div>
                          </div>
                       </div>
          ...
          <div className="fixed inset-0 z-[400] bg-black/80 backdrop-blur-xl flex items-center justify-center p-4 animate-in fade-in duration-300">
            <div className="glass w-full max-w-4xl border border-white/5 rounded-[3rem] p-6 md:p-10 relative shadow-2xl max-h-[90vh] overflow-y-auto">
              ...
              <div className="flex items-center gap-6 mb-10">
                ...
                <div>
                    <h3 className="text-4xl font-black text-white tracking-tight">{editingProgress.studentName}</h3>
                    <p className="text-[11px] font-black uppercase text-indigo-400 tracking-[0.2em] mt-2">Hafta #0{editingProgress.weekNumber} Monitoringini Tahrirlash</p>
                </div>
              </div>
            ...
            <div className="bg-[#0a0a0c] w-full max-w-2xl border border-white/5 rounded-[3rem] p-6 md:p-10 relative shadow-2xl">
              ...
              <div className="space-y-6">
                <div className="space-y-3">
                  ...
                  <CustomDropdown
                    options={allUsers
                      .filter(u => u.role === 'student' && (!u.assignedCuratorId || u.assignedCuratorId !== user?.id))
                      .map(u => ({
                        value: u.id,
                        label: u.name,
                        icon: u.avatar ? (
                    ...
                    className="w-full"
                  />
                  {allUsers.filter(u => u.role === 'student' && (!u.assignedCuratorId || u.assignedCuratorId !== user?.id)).length === 0 && (
